...
export default async function DashboardPage(){
 ...
 return <main className="ops-workspace">
  ...
  <section className="ops-main"><header className="ops-topbar"><div><p>MONDAY, AUGUST 25</p><h1>Good afternoon, Olu.</h1></div><div className="ops-actions"><a href="/dashboard/quotes" className="ops-quote-button">Review {newQuotes} quote{newQuotes===1?"":"s"} →</a></div></header>
