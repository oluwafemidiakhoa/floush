...
export default function HomePage() {
  return (
    <main className="new-site">
      ...
      <section className="new-stats"><div><b>24/7</b><span>SHIPMENT VISIBILITY</span></div><div><b>{usdotNumber}</b><span>USDOT</span></div><div><b>1</b><span>RELIABLE PARTNER</span></div><p>Delivering Excellence.<br/><strong>Driving Trust.</strong></p></section>
      ...
      <section id="quote" className="new-quote"><div><p className="new-eyebrow">━ START A CONVERSATION</p><h2>Let&apos;s move<br/><i>something forward.</i></h2><p>Tell us where your freight is headed. Our team will come back with a clear plan.</p><strong className="new-phone">CALL FLOUSH<a href={businessPhoneHref}>{businessPhoneDisplay}</a></strong><p>USDOT {usdotNumber}</p></div><QuoteForm/></section>
      <footer className="new-footer"><a className="new-brand" href="#top"><span>F</span> FLOUSH <em>LOGISTICS</em></a><p>© 2026 Floush Logistics LLC · USDOT {usdotNumber}</p><div><a href="mailto:quotes@floushlogistics.com">quotes@floushlogistics.com</a><a href="/dashboard">Operations</a></div></footer>
    </main>
  );
}