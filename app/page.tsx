...
export default function HomePage() {
  return (
    <main className="new-site">
      ...
      <section className="new-stats"><div><b>24/7</b><span>SHIPMENT VISIBILITY</span></div><div><b>48</b><span>STATES COVERED</span></div><div><b>1</b><span>RELIABLE PARTNER</span></div><p>Delivering Excellence.<br/><strong>Driving Trust.</strong></p></section>
      ...
      <section id="why-us" className="new-why"><div><p className="new-eyebrow">━ THE FLOUSH STANDARD</p><h2>Freight is personal.<br/><i>So is our service.</i></h2></div><div className="new-reasons"><article><b>01</b><div><h3>Clear from the start</h3><p>One accountable team, honest updates, and no disappearing acts.</p></div></article><article><b>02</b><div><h3>Built on follow-through</h3><p>We manage the details before they become problems on the road.</p></div></article><b>03</b><div><h3>Partner, not just carrier</h3><p>Your freight plan should support the way your business grows.</p></div></div></section>
      <section id="quote" className="new-quote"><div><p className="new-eyebrow">━ START A CONVERSATION</p><h2>Let&apos;s move<br/><i>something forward.</i></h2><p>Tell us where your freight is headed. Our team will come back with a clear plan.</p><strong className="new-phone">CALL FLOUSH<a href={businessPhoneHref}>{businessPhoneDisplay}</a></strong></div><QuoteForm/></section>
      <footer className="new-footer"><a className="new-brand" href="#top"><span>F</span> FLOUSH <em>LOGISTICS</em></a><p>© 2026 Floush Logistics LLC</p><div><a href="mailto:quotes@floushlogistics.com">quotes@floushlogistics.com</a><a href="/dashboard">Operations</a></div></footer>
    </main>
  );
}